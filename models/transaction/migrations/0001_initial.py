# Generated by Django 3.0.1 on 2020-01-12 15:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_sold', models.BooleanField(default=False, verbose_name='매수 후 매도 전환 여부')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('condition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='transaction.OrderCondition')),
            ],
            options={
                'db_table': 'order',
            },
